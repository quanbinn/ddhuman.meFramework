...
ExperimentsController {
  ctx: {
    request: { method: 'GET', url: '/experiment/showAll', header: [Object] },
    response: {
      status: 404,
      message: 'Not Found',
    ...
    app: {
      env: 'local',
      name: 'ddhumanme',
      baseDir: 'C:\\Users\\xiab-a\\ddhumanme',
      subdomainOffset: 2,
      config: '<egg config>',
    ...
    originalUrl: '/experiment/showAll',
  ...
  config: {
    ...
    onerror: {
      errorPageUrl: '',
      appErrorFilter: null,
      templatePath: 'C:\\Users\\xiab-a\\ddhumanme\\node_modules\\egg-onerror\\lib\\onerror_page.mustache'
    },
    i18n: {
      defaultLocale: 'en_US',
      dirs: [Array],
    ...
    multipart: {
      ...
      fileExtensions: [],
      whitelist: null,
      tmpdir: 'C:\\Users\\xiab-a\\AppData\\Local\\Temp\\egg-multipart-tmp\\ddhumanme',
    ...
    static: {
      prefix: '/public/',
      dir: 'C:\\Users\\xiab-a\\ddhumanme\\app\\public',
      dynamic: true,
      preload: false,
      buffer: false,
      maxFiles: 1000
    ...
    env: 'local',
    name: 'ddhumanme',
    keys: 'ddhumanme_1606199121087_6315',
    cookies: {},
    proxy: false,
    maxIpsCount: 0,
    maxProxyCount: 0,
    ...
    baseDir: 'C:\\Users\\xiab-a\\ddhumanme',
    HOME: 'C:\\Users\\xiab-a',
    rundir: 'C:\\Users\\xiab-a\\ddhumanme\\run',
    dump: { ignore: [Set] },
    ...
    logger: {
      dir: 'C:\\Users\\xiab-a\\ddhumanme\\logs\\ddhumanme',
      encoding: 'utf8',
      env: 'local',
      level: 'INFO',
      consoleLevel: 'INFO',
